...
function createBody(x, y, bodyHeight, addPointMass, addCircle) {
    headLength = bodyHeight / 7.5;
    headWidth = headLength * 3/4;

    head = new PointMass(x + Math.random(-5,5),y + Math.random(-5,5));
    head.mass = 4;
    shoulder = new PointMass(x + Math.random(-5,5),y + Math.random(-5,5));
    shoulder.mass = 26; // shoulder to torso
    head.attachTo(shoulder, 5/4 * headLength, 1, bodyHeight*2, true);
            
    elbowLeft = new PointMass(x + Math.random(-5,5),y + Math.random(-5,5));
    elbowRight = new PointMass(x + Math.random(-5,5),y + Math.random(-5,5));
    ...
    handLeft = new PointMass(x + Math.random(-5,5),y + Math.random(-5,5));
    handRight = new PointMass(x + Math.random(-5,5),y + Math.random(-5,5));
    handLeft.mass = 2;
    handRight.mass = 2;
    ...
    pelvis = new PointMass(x + Math.random(-5,5),y + Math.random(-5,5));
    ...
    kneeLeft = new PointMass(x + Math.random(-5,5),y + Math.random(-5,5));
    kneeRight = new PointMass(x + Math.random(-5,5),y + Math.random(-5,5));
    kneeLeft.mass = 10;
    kneeRight.mass = 10;
    kneeLeft.attachTo(pelvis, headLength*2, 1, bodyHeight*2, true);
    kneeRight.attachTo(pelvis, headLength*2, 1, bodyHeight*2, true);
            
    footLeft = new PointMass(x + Math.random(-5,5),y + Math.random(-5,5));
    footRight = new PointMass(x + Math.random(-5,5),y + Math.random(-5,5));
